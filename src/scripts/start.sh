...
nohup java -Dlog4j2.formatMsgNoLookups=true -Xms2048M -Xmx2048M -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/home/ec2-user/dump -javaagent:/opt/datadog/apm/library/java/dd-java-agent.jar -Ddd.logs.injection=true -Ddd.service=KiT_Page -Ddd.env=prod -Ddd.version=$VERSION -Ddd.profiling.enabled=true -Duser.timezone=Asia/Seoul -DLOG_HOME=/home/nonstop/logs -Dspring.profiles.active=$IDLE_PROFILE -jar $DEPLOY_JAR > /dev/null 2>&1 &
