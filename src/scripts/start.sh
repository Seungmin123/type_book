...
cd /home/ec2-user/nonstop/build/libs
echo "> 복사좀 되어라 !!!" >> /home/ec2-user/nonstop/logs/deploy.log
BUILD_JAR=$(ls *-boot.jar)
JAR_NAME=$(basename $BUILD_JAR)
echo "> build 파일명: $JAR_NAME" >> /home/ec2-user/nonstop/logs/deploy.log

echo "> build 파일 복사" >> /home/ec2-user/nonstop/logs/deploy.log
...
nohup java -Dlog4j2.formatMsgNoLookups=true -Xms1024M -Xmx1024M -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/home/ec2-user/dump -Duser.timezone=Asia/Seoul -Dspring.profiles.active=$IDLE_PROFILE -jar $DEPLOY_JAR 1> /dev/null 2>&1 &
